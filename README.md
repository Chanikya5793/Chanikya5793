...
**AI & Security Software Engineer | Secure AI systems · RAG · endpoint detection · cloud engineering**

I build intelligent systems that are secure by design, combining applied AI, cloud engineering, and security automation. My work spans RAG and LLM applications, voice systems, endpoint detection, identity protection, mobile security, and cloud infrastructure.
...
**Python · FastAPI · GCP · Vertex AI · Gemini · RAG · MCP · Cloud Run · Cloud KMS · Firebase**
...
**React Native · TypeScript · Signal Protocol · Swift · Kotlin · Firebase**
...
- Protected the data and model boundaries with least privilege, encrypted transport and storage, managed secrets, parameterized SQL, rate limits, bounded tool access, validation, and safe refusals.

## Technical Focus

- **AI:** RAG, LLM applications, MCP, Gemini, Vertex AI, embeddings, vector search, grounded generation, structured outputs, evaluation, prompt safety
...
- **Cloud and backend:** AWS, GCP, Cloudflare, Firebase, Docker, FastAPI, REST, Cloud KMS, Secret Manager, SQLite
- **Languages and frameworks:** Python, TypeScript, JavaScript, Swift, Kotlin, SQL, React Native, React, GitHub Actions
